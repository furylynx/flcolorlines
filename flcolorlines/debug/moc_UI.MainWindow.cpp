/****************************************************************************
** Meta object code from reading C++ file 'UI.MainWindow.hpp'
**
...
#include "../src/ui/UI.MainWindow.hpp"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'UI.MainWindow.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(8, 97, 18)
    ...
    "ui::MainWindow\0clickedUndo\0\0clickedRedo\0"
    "clickedNewGame\0clickedExit\0clickedAbout\0"
    "clickedHighscore\0aboutToShowActions\0"
};
...
void ui::MainWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->clickedUndo(); break;
        case 1: _t->clickedRedo(); break;
        case 2: _t->clickedNewGame(); break;
        case 3: _t->clickedExit(); break;
        case 4: _t->clickedAbout(); break;
        case 5: _t->clickedHighscore(); break;
        case 6: _t->aboutToShowActions(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
